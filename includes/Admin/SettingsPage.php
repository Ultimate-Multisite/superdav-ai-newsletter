				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<?php else : ?>
								<span style="color:#b32d2e;">&#x2718;&nbsp;<?php esc_html_e( 'Not active. Install the Newsletter plugin (by Stefano Lissa) to use AI personalization.', 'superdav-ai-newsletter' ); ?></span>
							<?php endif; ?>
						</td>
					</tr>
				</tbody>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<p class="description"><?php esc_html_e( 'Per-segment and Hybrid modes are scaffolded in v0.1; only Per-recipient and Hybrid currently rewrite per-recipient bodies.', 'superdav-ai-newsletter' ); ?></p>
							</td>
						</tr>
							...
							<td>
								...
								<p class="description"><?php
									printf(
										...
										esc_html__( 'Available placeholders: %s. The %s placeholder is replaced with the original email body.', 'superdav-ai-newsletter' ),
